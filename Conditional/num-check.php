    ...
    <div class=" flex justify-center mt-10">
        <form class="w-full max-w-sm" method="post" action="">
            <div class="flex items-center border-b border-teal-500 py-2">
                <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="number" placeholder="Enter Your Number" name="number" aria-label="Full name">
